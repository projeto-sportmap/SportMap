...
openModal1.addEventListener("click", function (event) {
    ...
    const titulo = document.getElementById("titulo-termo");

    titulo.innerHTML = "TERMOS DE USO — SPORTMAP";
...
openModal2.addEventListener("click", function (event) {
    ...
    titulo.innerHTML = "POLÍTICA DE PRIVACIDADE — SPORTMAP";
